...
from .views import SuperUserHomeView ,UserEditView, OrderEditView, OldItemView, NewItemView, UserInformationView, SignUpView, TestView, DeductionOutputView
...
urlpatterns = [
    ...
    path('userinformation/<int:user_id>/', UserInformationView.as_view(), name='userinformation_detail'),
    path('signup/',SignUpView.as_view(), name='signup'),
    path('test/',TestView.as_view(), name='test'),
    path('deductionoutput/',DeductionOutputView.as_view(), name='deductionoutput'),
